...
class MainActivity : AppCompatActivity() {
    ...
    myDataList.add(UserData("polimera","polimera@gmail.com","5443543154"))
    myDataList.add(UserData("sai","sai@gmail.com","1234567890"))
    myDataList.add(UserData("khanith","khanith@gmail.com","6278346275"))
    myDataList.add(UserData("ramesh","ramesh@gmail.com","7754166577"))
    myDataList.add(UserData("chandana","chandana@gmail.com","7718548277"))
    myDataList.add(UserData("pavan","pavan@gmail.com","7854545675"))
    myDataList.add(UserData("vijaya","vijaya@gmail.com","7674386315"))
    myDataList.add(UserData("ramulu","ramulu@gmail.com","7526546821"))
